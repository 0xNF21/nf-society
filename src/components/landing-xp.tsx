...
export default function LandingXp() {
  ...
  const t = translations.landingMarketingXp;
      ...
      <section className="bg-ink/[0.02] dark:bg-white/[0.02] py-20 border-y border-ink/5 dark:border-white/5">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <HowStep icon={<Gamepad2 className="h-6 w-6" />} title={t.howStep1Title[locale]} desc={t.howStep1Desc[locale]} />
            <HowStep icon={<Sparkles className="h-6 w-6" />} title={t.howStep2Title[locale]} desc={t.howStep2Desc[locale]} />
            <HowStep icon={<Trophy className="h-6 w-6" />} title={t.howStep3Title[locale]} desc={t.howStep3Desc[locale]} />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 space-y-6 text-sm text-ink/50 dark:text-white/50">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Image src="/nf-society-logo.png" alt="NF Society" width={18} height={18} className="h-4 w-auto opacity-70" />
