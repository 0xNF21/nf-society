...
export async function POST(req: NextRequest) {
  const limited = await enforceRateLimit(req, "coin-flip-start-free", 20, 60000);
  ...
  try {
    ...
    console.error("[coin-flip/start-free] error:", err);
