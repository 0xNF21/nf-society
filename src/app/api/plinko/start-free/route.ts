...
export async function POST(req: NextRequest) {
  const limited = await enforceRateLimit(req, "plinko-start-free", 20, 60000);
  ...
  try {
    ...
    console.error("[plinko/start-free] error:", err);
