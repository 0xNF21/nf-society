...
export async function POST(req: NextRequest) {
  const limited = await enforceRateLimit(req, "lootbox-start-free", 20, 60000);
  ...
  try {
    ...
    console.error("[lootbox/start-free] error:", err);
