      ...
      <div className="grid gap-0.5" style={{ gridTemplateColumns: `repeat(${GRID_SIZE}, 1fr)` }}
        ...
        {Array.from({ length: GRID_SIZE }, (_, r) =>
          Array.from({ length: GRID_SIZE }, (_, c) => {
            ...
            return (
              <div key={key}
                className={`w-7 h-7 sm:w-8 sm:h-8 rounded-sm cursor-pointer border border-ink/5 dark:border-white/5 flex items-center justify-center text-xs transition-colors relative ${bg}`}
